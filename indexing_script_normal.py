...
# RUN
# python3 indexing_script_normal.py --marqo_url=http://0.0.0.0:8882 --index_name=sakhi_activity --folder_path=/home/ttpl-rt-057/Documents/dpdpa --fresh_index (FOR FRESH INDEXING)
# python3 indexing_script_normal.py --marqo_url=http://0.0.0.0:8882 --index_name=sakhi_activity --folder_path=input_data (FOR APPENDING DOCUMENTS)
